...
author: "Rick Gilmore, Frank Hillary, & Nicole Lazar"
date: "`r Sys.Date()`"
...
```{r, out.width="80%", fig.cap="Describe your awareness of the FAIR (findable, accessible, interoperable, reusable) principles pertaining to research data"}
...
**GitHub repository**: <https://github.com/penn-state-open-science>

**This talk**: <https://penn-state-open-science.github.io/2023-01-17-Child-Study-Center/>
